$(document).ready(function() {
    ...
    */
    ...
    for (var i = 0; i < data.length; i++) {
        $("#menue").append(
            "<li class = 'myitemf' > " + data[i].label +
            " <ul>" +
            "   <li class='myitemf'>" +
            "     <ul>" +
            "       <li class='myitem'>" +
            "         <input id='adueb' value='" + "    " + data[i].children[0].label +
            "           ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
            "           \"" + data[i].children[0].label + "\" )'>" +
            "       </li>" +
            "       <li class='myitem'>" +
    ...
    */
    ...
    $("#menue").append("<ul> " +
        ...
        */
        ...
        " <ul>" +
        "   <li class='myitemf'><a href='#'>" + data[1].children[0].label + "</a>" + "</li>" +
        "   <li class='myitemf'><a href='#'>" + data[1].children[0].children[0].label + "</a>" + "</li>" +
        "   <li class='myitemf'><a href='#'>" + data[1].children[0].children[1].label + "</a>" + "</li>" +
        "   <li class='myitemf'><a href='#'>" + data[1].children[1].label + "</a>" + "</li>" +
        " </ul>" +
        "</li>" +
        /*
        " <ul>" +
        "  <li class='myitemf'>" +
        "    <ul>" +
        "     <li class='myitemf'><a href='#'>" + data[1].children[0].label + "</a>" +

        "     <li class='myitem'>" +
        "       <input id='waue1' value='" + data[1].children[1].label +
        "         ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
        "         \"" + data[1].children[1].label + "\" )'>" +
        "     </li>" +
        "     <li class='myitem'><a href='#'>" + data[1].children[0].label + "</a></li>" +
        "    </ul>" +
        "  </li>" +
        " </ul>" +
        "</li>" +
        */
        ...
        " <ul>" +
        "   <li class='myitem'>" +
        "     <input value='    " + data[4].children[0].label +
        "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
        "       \"" + data[4].children[0].label + "\" )'>" +
        "   </li>" +
        "   <li class='myitem'>" +
        "     <input value='    " + data[4].children[1].label +
        "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
        "       \"" + data[4].children[1].label + "\" )'>" +
        "   </li>" +
        "   <li class='myitem'>" +
        "     <input value='    " + data[4].children[2].label +
        "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
        "       \"" + data[4].children[2].label + "\" )'>" +
        "   </li>" +
        "   <li class='myitem'>" +
        "     <input value='    " + data[4].children[3].label +
        "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
        "       \"" + data[4].children[3].label + "\" )'>" +
        "   </li>" +
        " </ul>" +
        "</li>" +
        "</li>"
