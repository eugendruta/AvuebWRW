$(document).ready(function () {
  ...
  $("#menue").append("<ul>" +
    ...
    "   </li>" +
    "   <li class='myitem'>" +
    "     <input id='poueb' value='     " + data[1].children[0].children[1].label + //POUEB: Positions-Übersicht
    "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
    "       \"" + data[1].children[0].children[1].label + "\" )'>" +
    "   </li>" +
    ...
    " <ul>" +
    "   <li class='myitem'>" +
    "     <input id='bsueb' value='    " + data[4].children[0].label +
    "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
    "       \"" + data[4].children[0].label + "\" )'>" +
    "   </li>" +
    "   <li class='myitem'>" +
    "     <input id='avueb' value='    " + data[4].children[1].label +
    "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
    "       \"" + data[4].children[1].label + "\" )'>" +
    "   </li>" +
    "   <li class='myitem'>" +
    "     <input id='avdet'value='    " + data[4].children[2].label +
    "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
    "       \"" + data[4].children[2].label + "\" )'>" +
    "   </li>" +
    "   <li class='myitem'>" +
    "     <input id='bprot'value='    " + data[4].children[3].label +
    "       ' type='submit' style='max-width: 250px; float: left;' onclick='naviclickdia(" +
